...
The simulator was implemented in Matlab with GUI. Make sure that [MATLAB](https://de.mathworks.com/products/matlab.html) with version `>2022a` and the following toolboxes [TODO!] are installed.
